...
describe("rollup-plugin-shims", () => {
  ...
  it("allow to add shims by config", () => {
    return expect(run({ add: ["Object.values"] }, "1 + 1")).to.eventually.equal(
      wrap(common, ObjectValues),
    );
  });
